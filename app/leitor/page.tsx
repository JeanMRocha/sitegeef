    ...
    <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 0.5rem", fontSize: "0.9rem", color: "#999" }}>Empréstimos Ativos</p>
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 0.5rem", fontSize: "0.9rem", color: "#999" }}>Em Atraso</p>
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 0.5rem", fontSize: "0.9rem", color: "#999" }}>Reservas Aguardando</p>
      ...
      <div style={{ marginBottom: "2rem" }}>
        <h2 style={{ margin: "0 0 1rem", fontSize: "1.3rem", fontWeight: 600 }}>📚 Meus Empréstimos</h2>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ textAlign: "right" }}>
                    <p style={{ margin: "0 0 0.5rem", fontSize: "0.85rem", color: "#999" }}>Devolve em</p>
                    <p style={{
                      margin: "0.25rem 0",
                      fontSize: "1rem",
                      fontWeight: 600,
      ...
      <div>
        <h2 style={{ margin: "0 0 1rem", fontSize: "1.3rem", fontWeight: 600 }}>⏳ Minhas Reservas</h2>
        {reservas.length > 0 ? (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {reservas.map((res: any) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ textAlign: "right" }}>
                    <p style={{ margin: "0 0 0.5rem", fontSize: "0.85rem", color: "#999" }}>Posição na fila</p>
