...
} from "../../instituicao/musicas/actions";
import {
  getMusicaById,
  getMusicasResumo,
  listMusicaSessoes,
              ...
              <tbody>
                {musicas.map((musica) => (
                  <tr key={musica.id}>
                    ...
                    <td>
                      <Link href={`/admin/reuniao-publica/musicas?id=${musica.id}`} className="profile-form-btn profile-form-btn-secondary">
                        Editar
                      </Link>
                    </td>
                  </tr>
...
export default function MusicasReuniaoPublicaPage(props: PageProps) {
  return (
    <AdminModuleGate
